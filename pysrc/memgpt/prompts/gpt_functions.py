...
FUNCTIONS_CHAINING = {
    ...
    "pause_heartbeats": {
        ...
        "description": (
            "Temporarily ignore timed heartbeats. You may still receive messages from manual heartbeats and other"
            " events."
        ),
        "parameters": {
            "type": "object",
    ...
    "message_chatgpt": {
        ...
        "description": (
            "Send a message to a more basic AI, ChatGPT. A useful resource for asking questions. ChatGPT does not"
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "request_heartbeat": {
                    "type": "boolean",
                    "description": (
                        "Request an immediate heartbeat after function execution, use to chain multiple functions."
                    ),
                },
            },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "page": {
                    "type": "integer",
                    "description": (
                        "Allows you to page through results. Only use on a follow-up query. Defaults to 0 (first"
                        " page)."
                    ),
                },
                "request_heartbeat": {
