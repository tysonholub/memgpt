...
MESSAGE_SUMMARY_WARNING_TOKENS = (
    7000  # the number of tokens consumed in a call before a system warning goes to the agent
)
MESSAGE_SUMMARY_WARNING_STR = (
    f"Warning: the conversation history will soon reach its maximum length and be trimmed. Make sure to save any"
    f" important information from the conversation to your memory before it is removed."
)
...
FUNCTION_PARAM_DESCRIPTION_REQ_HEARTBEAT = (
    "Request an immediate heartbeat after function execution. Set to 'true' if you want to send a follow-up message or"
    " run a follow-up function."
)
